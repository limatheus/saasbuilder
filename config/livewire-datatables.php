...
return [
    ...
    */
    ...
    'default_classes' => [
        'row' => [
            'even' => 'divide-x divide-slate-100 dark:divide-dark-border text-sm text-slate-900 dark:text-dark-text bg-slate-100 dark:bg-dark-card-two',
            'odd' => 'divide-x divide-slate-100 dark:divide-dark-border text-sm text-slate-900 dark:text-dark-text bg-slate-50 dark:bg-dark-card-shade',
            'selected' => 'divide-x divide-slate-100 dark:divide-dark-border text-sm text-slate-900 dark:text-dark-text bg-yellow-100',
        ],
        'cell' => 'whitespace-no-wrap text-sm text-slate-900 dark:text-dark-text px-6 py-2',
    ],
];
